...
const SupportLinkCardItem = ({ item }: SupportLinkCardItemProps) => {
  return (
    <a
      ...
      className="flex flex-col md:flex-row md:items-center gap-4 transition-colors duration-300 p-2 cursor-pointer rounded-md hover:bg-neutral-50 focus-visible:ring-1 ring-primary!"
    >
      <div
        className={`h-10 w-10 rounded-md flex items-center justify-center shrink-0 ${
          item.backgroundIconColor || "bg-neutral-100"
        }`}
      >
        {item.icon || (

...
const CompanyCard = ({ company, isLast = false }: CompanyCardProps) => {
  return (
    <Row className="gap-3 sm:gap-4 md:gap-6 lg:gap-8">
      ...
      >
        <Card className="relative overflow-hidden p-4 sm:p-5 md:p-6 lg:p-8 transition-all duration-300 hover:ring-2 hover:ring-primary hover:-translate-y-1 shadow-lg">
